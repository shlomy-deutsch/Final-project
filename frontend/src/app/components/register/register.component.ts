...
export class RegisterComponent{
  ...
  constructor(
    ...
    private notify: NotifyService,
      ...
      this.id = new FormControl('', [Validators.max(999999999), Validators.min(10000000), Validators.required]);
      this.username = new FormControl(null, [Validators.required, Validators.pattern("^[A-Za-z0-9+_.-]+@(.+)$")]);
